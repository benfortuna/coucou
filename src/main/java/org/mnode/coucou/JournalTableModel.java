 ...
 *
 */
public class JournalTableModel extends AbstractNodeTableModel {

    private static final long serialVersionUID = 1L;
    
    private static final LogAdapter LOG = new JclAdapter(LogFactory.getLog(JournalTableModel.class));

    /**
     * @param node
     */
    public JournalTableModel(Node node) {
        super(node, new String[] {"Subject", "Tags", "Last Modified"},
